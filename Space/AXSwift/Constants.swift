...
public enum AXAttribute: String, Codable {
    // Standard attributes
    ...
    // Additional attributes found by testing
    case domIdentifier = "AXDOMIdentifier"

    case ariaCurrent = "AXARIACurrent"
    case elementBusy = "AXElementBusy"
    case axRequired = "AXRequired"
    case editableAncestor = "AXEditableAncestor"
    case highestEditableAncestor = "AXHighestEditableAncestor"
    case startTextMarker = "AXStartTextMarker"
    case selectedTextMarkerRange = "AXSelectedTextMarkerRange"
